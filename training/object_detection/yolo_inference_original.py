...
IMAGE_PATH = str(Path(__file__).parent.parent / 'data' / 'images' / '159602_1.png')
...
if __name__ == "__main__":
    ...
    yolo_detections = detections_to_yolo_format(detections, img_height, img_width)
    print(f"\nDetections: {detections}.\n In yolo: {yolo_detections}")
    ...
    cv2.imwrite('annotated_dog.png', annotated_image)
